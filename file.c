 ...
 */
fsal_status_t cloud_open(struct fsal_obj_handle *ffile, fsal_openflags_t fflags)
{
 ...
 * Return Value: fsal status
 */
fsal_openflags_t cloud_status(struct fsal_obj_handle *ffile)
{
   LogCrit(COMPONENT_FSAL, "%s", __FUNCTION__);
 ...
 * Return Value: fsal status
 */
fsal_status_t cloud_read(struct fsal_obj_handle *ffile,
 ...
 */
fsal_status_t cloud_write(struct fsal_obj_handle *ffile,
                uint64_t offset, size_t buffer_size, void *buffer,
...
fsal_status_t cloud_commit(struct fsal_obj_handle *obj_hdl,    /* sync */
...
fsal_status_t cloud_lock_op(struct fsal_obj_handle *ffile,
 ...
 * Return Value: fsal status
 */
fsal_status_t cloud_close(struct fsal_obj_handle *ffile)
{
   LogCrit(COMPONENT_FSAL, "%s", __FUNCTION__);
    return fsalstat(ERR_FSAL_NO_ERROR, 0);
...
fsal_status_t cloud_lru_cleanup(struct fsal_obj_handle *ffile,
